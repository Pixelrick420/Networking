...
int main() {
    ...
    sendToClient(server, "CONNECTION OK");

    recvFromClient(server, buffer);
    sendToClient(server, "HELO response");

    recvFromClient(server, buffer);
    sendToClient(server, "SENDER OK");

    recvFromClient(server, buffer);
    sendToClient(server, "RECEIVER OK");

    recvFromClient(server, buffer);
    sendToClient(server, "MAIL BODY RECEIVED");

    recvFromClient(server, buffer);
    sendToClient(server, "BYE");
